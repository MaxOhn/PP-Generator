...
import main.java.commands.Osu.cmdGlobalLeaderboard;
...
public class cmdRecentGlobalLeaderboard extends cmdGlobalLeaderboard implements INumberedCommand {
    ...
    public String help(int hCode) {
        ...
        switch(hCode) {
            case 0:
                return "Enter `" + statics.prefix + getName() + "globalleaderboard[number] [osu name]` to make me show the global top 10 scores on the beatmap of the user's last play."
                        + "\nIf a number is specified, e.g. `" + statics.prefix + getName() + "globalleaderboard8`, I will skip the most recent 7 scores "
